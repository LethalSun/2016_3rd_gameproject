...
//
//
//int IniReader::ReadInteger(const char* Section, const char* Key, int IntDefaultValue)
//{
...
//
//
//float IniReader::ReadFloat(const char* Section, const char* Key, float FloatDefaultValue)
//{
//	char Result[255];
//	char Default[255];
//	float FloatResult;
